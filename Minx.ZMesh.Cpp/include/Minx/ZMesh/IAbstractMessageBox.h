...
namespace Minx::ZMesh
{
    ...
    public:
        ...
        using AnswerHandler = std::function<MessageResponse(const std::string&)>;
        ...
        virtual MessageResponse Ask(std::string_view content_type) = 0;
        virtual MessageResponse Ask(std::string_view content_type, std::string_view content) = 0;
        virtual MessageResponse Ask(std::string_view content_type, std::string_view content, std::chrono::milliseconds timeout) = 0;
        virtual MessageResponse Ask(std::string_view content_type, std::string_view content, std::stop_token stop_token) = 0;
